...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    <form id="form1" runat="server" class="font-sans text-sm rounded w-full mx-auto"> 
        ...
        <div id="extra" class="container flex items-center justify-between">
            <section class="bg-white py-4 my-8 px-8 pt-6 pb-8 w-1/2">
                <div class="container py-2 px-4">
                    <div>
			            <asp:Label ID="lbErrMessage" class="text-red" runat="server" Text=""></asp:Label>
		            </div>
                    ...
                    <div class="relative border rounded mb-4 shadow appearance-none ">
			            <asp:TextBox ID="tbFirstName" class="w-full py-2 px-3 text-gray-700 leading-normal rounded" runat="server"></asp:TextBox>
		            </div>
                    <asp:Label ID="lbErrFirstName" class="text-red" runat="server" Text=""></asp:Label>
                    <div class="relative border rounded mb-4 shadow appearance-none ">
			            <asp:TextBox ID="tbLastName" class="w-full py-2 px-3 text-gray-700 leading-normal rounded" runat="server"></asp:TextBox>
		            </div>
                    <asp:Label ID="lbErrLastName" class="text-red" runat="server" Text=""></asp:Label>
                    <div class="relative border rounded mb-4 shadow appearance-none ">
			            <asp:TextBox ID="tbEmail" class="w-full py-2 px-3 text-gray-700 leading-normal rounded" runat="server"></asp:TextBox>
		            </div>
                    <asp:Label ID="lbErrEmail" class="text-red" runat="server" Text=""></asp:Label>
                    <div class="relative border rounded mb-4 shadow appearance-none ">
			            <asp:TextBox ID="tbPassword" class="w-full py-2 px-3 text-gray-700 leading-normal rounded" runat="server"></asp:TextBox>
		            </div>
                    <asp:Label ID="lbErrPassword" class="text-red" runat="server" Text=""></asp:Label>
                    <div class="relative border rounded mb-4 shadow appearance-none ">
			            <asp:TextBox ID="tbConfirm" class="w-full py-2 px-3 text-gray-700 leading-normal rounded" runat="server"></asp:TextBox>
		            </div>
           ...
           <section class="bg-gray-300 py-4 my-8 px-8 pt-6 pb-8 w-1/2">
               <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="ListView1_SelectedIndexChanged" DataKeyNames="id">
                    <AlternatingItemTemplate>
                        <li class="border-b border-gray-300 bg-white flex justify-between items-center py-4 px-4 mt-3">
                            <asp:Label ID="idLabel" runat="server" class="w-2/12 px-3" Text='<%# Eval("id") %>' />
                            ...
                            <asp:Button ID="btnEdit" class="w-1/12 bg-black hover:bg-gray-700 text-white py-2 px-4" runat="server" Text="Edit" OnClientClick='<%# "return editUser(this)"%>'/>                        
                        </li>
                    </AlternatingItemTemplate>
                    <EmptyDataTemplate>
                    ...
                    <LayoutTemplate>
                        <ul id="itemPlaceholderContainer" class="font-sans list-none p-0 container m-auto text-gray-900" runat="server" style="">
                            <li class="border-b border-gray-300 bg-white flex justify-between items-center py-4 px-4 mt-3">
                                <asp:Label ID="idLabelHead" class="w-2/12 px-3" runat="server" Text='User ID' />
