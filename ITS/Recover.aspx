...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    <div id="extra" class="container font-sans text-sm rounded w-full max-w-md mx-auto my-8 px-8 pb-8 ">
		...
		<div class="flex items-center justify-between">
			<asp:Button ID="btnReset" class="bg-black hover:bg-gray-700 text-white py-2 px-4" runat="server" Text="Request PasswordReset" accesskey="2" OnClientClick="return validationRecover();"  OnClick="btnReset_Click"/>
